...
// console.log(patient);
 ...
 d3.select("#actions").style("visibility","hidden");
  ...
  d3.select("#task-1").style("visibility","hidden");  
...
<!--           <a class="brand" href="index.html">Testing platform for wrong patient error</a>  -->
          ...
          <ul class="nav"> 
              ...
              <li><a href="list-slow.html">List</a></li>               
            </ul> 
          </div><!--/.nav-collapse --> 
        </div> 
      </div> 
...
<div style="height:100px;width:100%;clear:both">
		...
		<div style="float:left; width:25%;">
			...
			<div style="padding-top:30px;">
				...
				<div style="width:70%;float:left">
					...
					<b><?php echo getAge($_GET["id"]);
						?> </b> yo, <b><?php echo getSex($_GET["id"]);
						?> </b> 
				</div>
			</div>			
			<div>
				<div style="width:30%;float:left">dob:</div>
				<div style="width:70%;float:left"> 
					<b><?php echo getDOB($_GET["id"]);
						?> </b> 
				</div>
			</div> 
			<div>
				<div style="width:30%;float:left">clinician:</b></div> 
				<div style="width:70%;float:left"> 
					<b><?php echo getAttDoc($_GET["id"]);
						?> </b>
				</div>
		   </div>
		   <div>
	...
	<div id="task-1" style="float:right; height:100%; padding-left:10px;width:60%">  
	<h6>Summary Status</h6>
    	<div id="summary-status" style="font-size:11px">
